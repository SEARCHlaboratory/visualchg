  ...
  "hypergraph": {
    ...
    "edges": [
      ...
      },
      {
        ...
        "target": "omega",
        "weight": 1.0,
        "index_via": "index_via=lambda slope, initial_val: slope - 1 == initial_val,\\n",
        "disposable": [
          "slope",
          "intial_val"
        ]
      ...
      },
      {
        ...
        "rel": "self.rel = lambda *args, **kwargs: self.og_rel(*args, **og_kwargs(**kwargs))\\n",
        "source_nodes": {
          "s1": "theta",
          "s2": "omega",
          "s3": "('s1', 'index')",
